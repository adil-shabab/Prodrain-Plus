                ...
                <div class="row">
                    <div class="col-md-6 col-12 d-flex align-items-center justify-content-center">
                        <div class="banner-head">
                            <h2  data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">Dental Implants</h2>
                            <p data-aos="fade-right" data-aos-duration="1300" data-aos-delay="400">Self Threading Effect </p>
                            <p class="sm-desc" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="400">Through cutting-edge research, we seek to create ground-breaking solutions for dental professionals worldwide. At Cybermed, we are committed to the creation of a healthy, beautiful smile by providing dental professionals with high-quality products, comprehensive education and training, and unrivaled customer service.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 d-flex align-items-center justify-content-center">
                        <img src="assets/images/services/dental/img-1.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12" style="margin-bottom:35px;">
                            <div class="row b_o_x">
                                <div class="mt-3 col-md-6 d-flex-full">
                                    <img src="assets/images/services/dental/banner-img.png" style="transform:rotate(315deg);" alt="" class="img-fluid">
                                </div>
                                <div class="mt-3 col-md-6 d-flex flex-column justify-content-center">
                                    <h4><span>High </span> Primary Stability</h4>
                                    <p>Smooth Implant Placement</p>
                                    <p>Self Threaading Effect</p>
                                    <p>Sharp Thread maximizes preservation of the existing bone and secures achorage</p>
                                    <p>Double Thread minimizes implant placement time</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12" style="margin-bottom:35px;">
                            <div class="row b_o_x">
                                <div class="mt-3 col-md-6 d-flex-full">
                                    <img src="assets/images/services/dental/ai.png" alt="" class="img-fluid">
                                </div>
                                <div class="mt-3 col-md-6 d-flex flex-column justify-content-center">
