                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 d-flex-full flex-column">
                            ...
                            <img src="assets/images/services/medical/kbelle.png" alt="" class="w-50 img-fluid mb-4">
                            <p class="text-white">In general, Hyaluronic acid tends to undergo chemical transformation easily at high cross linking rate. However, kbelle, our products proves that in the refractive index comparative eperiment, the same wavelength pattern maintains as the raw material initially has in spite of higher cross linking rate. Its shows 100% of HA maintains without any changes. In other words, there is no harmful effect even if the body absorbs it, both of raw material and the finished product are 100% of hyaluronic</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div>
                            <h6>Safe Material</h6>
                            <p>shiseido Co. Ltd in japan with European Pharmacopeia</p>
                        </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div>
                            <h6>Rigorous Process</h6>
                            <p>Developed DVS, MDAWO technology with purity of 97% or more and applied process</p>
                        </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div>
                            <h6>Stability & Effectiveness</h6>
                            <p>KFDA for medical device on 4th grade and CE, and DVS Washing technology</p>
                        </div>
                        </div>
                    </div>
                </div>
